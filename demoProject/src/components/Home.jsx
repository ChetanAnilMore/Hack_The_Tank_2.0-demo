...
export default function Home() {
  return (
    <>
      <nav className="w-full min-h-16 px-5 bg-purple-700 text-white flex sm:justify-between sm:flex-row flex-col items-center">
        <div className="logo mx-auto sm:mx-0">SmartPark</div>
        <ul className="flex space-x-5 justify-center sm:justify-normal">
          <li>
            <a href="#home">Home</a>
          </li>
          <li>
            ...
            <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
              ...
              <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                <div className="lg:w-1/2 px-6">
                  ...
                  <p className="mt-1">
                    C.K. Pithawala college of engineering and technology near surat airport, Surat, Gujarat, India
                  </p>
                </div>
